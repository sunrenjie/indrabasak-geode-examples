package com.basaki.example.geode.spring.controller;

import com.basaki.example.geode.spring.model.Book;
import com.basaki.example.geode.spring.model.BookRequest;
import com.basaki.example.geode.spring.service.BookService;
...
public class BookController {
    ...
    @ApiOperation(
            value = "Retrieves all books associated with a title and author.",
    ...
    public List<Book> get(
        ...
        return service.get(title, author);
    }
